...
<div id="page-wrapper">
	...
	<footer id="footer" role="contentinfo">
		<div class="footer-wrapper clearfix">
			...
			<?php if ($is_front): ?>More Advertising Agency Drupal Themes at <a rel="nofollow" href="http://www.templatemonster.com/category/advertising-agency-drupal-themes/" target="_blank">TemplateMonster.com</a><?php endif; ?>
		</div><!-- /#footer-wrapper -->
	</footer><!-- /#footer -->
